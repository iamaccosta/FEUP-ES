      ...
      child: MaterialApp(
          ...
          onGenerateRoute: (RouteSettings settings) {
            switch (settings.name) {
              ...
              case '/' + Constants.navAmigosArea:
                return PageTransition.makePageTransition(
                    page: AmigosPage(), settings: settings);
              case '/' + Constants.navGruposArea:
                return PageTransition.makePageTransition(
                    page: GruposPage(), settings: settings);
              case '/' + Constants.navEventosArea:
                return PageTransition.makePageTransition(
                    page: EventosPage(), settings: settings);
