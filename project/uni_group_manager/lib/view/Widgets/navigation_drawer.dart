...
class NavigationDrawerState extends State<NavigationDrawer> {
  ...
  void initState() {
    ...
    drawerItems = {
      ...
      Constants.navAmigosArea: _onSelectPage,
      Constants.navGruposArea: _onSelectPage,
      Constants.navEventosArea: _onSelectPage,
  ...
  _onSelectPage(String key) async{
    ...
    final int id = await interface.getValue(code, 'users', 'id');

    switch(key){
      case 'Amigos':
        await AmizadeController.init(code, id);
        break;
      case 'Grupos':
        await UserGroupsController.init(code, id);
        break;
      case 'Eventos':
        await UserGroupsController.init(code, id);
        break;
